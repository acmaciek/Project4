...
public class FrameGrader{
	...
	public FrameGrader(){
		...
		output.setFont(output.getFont().deriveFont(10f));
	...
	public void gradeExam(){
		...
		File saveFile = new File("csvFile.txt");
		...
		currExam.saveScoresToFile(pw);
		output.append("Save as Comma SeparatedFile: csvFile.txt <--\n");
		pw.close();
	}
